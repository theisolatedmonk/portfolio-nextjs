...
import Me from "@/public/seth.png";
    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:space-y-0 ">
        <div className="flex flex-col items-center pt-8">
          <Image
            src={Me}
            alt={"Picture of Rahul Seth"}
            className="h-48 w-48 rounded-full object-cover object-top"
          />
          <h3 className="pt-4 pb-2 text-2xl font-bold">Rahul Seth</h3>
          <p className="text-gray-500 dark:text-gray-300 text-center">
            Hey my name is Rahul Seth and I am a Frontend Developer
          </p>
          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/theisolatedmonk" target="_blank">
              <svg
            ...
            <a href="mailto:96rahulseth@gmail.com" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="h-8 w-8 text-teal-500 hover:text-teal-600"
